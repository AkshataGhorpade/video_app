...
class MovieScreenBottomSheet extends StatelessWidget {
  const MovieScreenBottomSheet({Key? key}) : super(key: key);
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(20, Get.height / 5, 20, 20),
              child: Column(
